        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                    <button type="submit" class="btn btn-danger form-control" style="background-color: #6777ef;border-color: #6777ef;box-shadow: 0 2px 6px #6777ef;">CADASTRAR MESA</button>
                </div>
              </div>
              </form>
            </div>
